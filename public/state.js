...
export const els = {
  ...
  adminLogisticsSection: document.getElementById("adminLogisticsSection"),
  adminLogisticsCurrentSchoolSelect: document.getElementById("adminLogisticsCurrentSchoolSelect"),
  adminLogisticsCurrentEnsembleSelect: document.getElementById("adminLogisticsCurrentEnsembleSelect"),
  adminLogisticsNextSchoolSelect: document.getElementById("adminLogisticsNextSchoolSelect"),
  adminLogisticsNextEnsembleSelect: document.getElementById("adminLogisticsNextEnsembleSelect"),
  adminLogisticsStatus: document.getElementById("adminLogisticsStatus"),
  adminLogisticsContent: document.getElementById("adminLogisticsContent"),
  adminSchedulerSection: document.getElementById("adminSchedulerSection"),
  adminSchedulerMessage: document.getElementById("adminSchedulerMessage"),
  schedulerFirstPerformanceInput: document.getElementById("schedulerFirstPerformanceInput"),
  schedulerFirstPerformanceSaveBtn: document.getElementById("schedulerFirstPerformanceSaveBtn"),
  adminSchedulerTimelineContainer: document.getElementById("adminSchedulerTimelineContainer"),
  schedulerApplyBtn: document.getElementById("schedulerApplyBtn"),
  ...
  adminViewEventChair: document.getElementById("adminViewEventChair"),
  adminEventChairDefineSection: document.getElementById("adminEventChairDefineSection"),
  eventChairDefineHint: document.getElementById("eventChairDefineHint"),
  eventChairShowCreateBtn: document.getElementById("eventChairShowCreateBtn"),
  eventChairCreateFormBlock: document.getElementById("eventChairCreateFormBlock"),
  eventChairCancelCreateBtn: document.getElementById("eventChairCancelCreateBtn"),
  eventChairEventNameInput: document.getElementById("eventChairEventNameInput"),
  eventChairStartAtInput: document.getElementById("eventChairStartAtInput"),
  eventChairEndAtInput: document.getElementById("eventChairEndAtInput"),
  eventChairCreateEventBtn: document.getElementById("eventChairCreateEventBtn"),
  eventChairDeadlineInput: document.getElementById("eventChairDeadlineInput"),
  eventChairCreateEventForm: document.getElementById("eventChairCreateEventForm"),
  eventChairEventList: document.getElementById("eventChairEventList"),
  eventChairDetailSection: document.getElementById("eventChairDetailSection"),
  ...
  adminViewCheckin: document.getElementById("adminViewCheckin"),
  ...
  checkinBackBtn: document.getElementById("checkinBackBtn"),
  checkinDetailTitle: document.getElementById("checkinDetailTitle"),
  checkinDetailMeta: document.getElementById("checkinDetailMeta"),
  checkinArrivalBtn: document.getElementById("checkinArrivalBtn"),
  checkinConfirmBtn: document.getElementById("checkinConfirmBtn"),
  checkinDetailContent: document.getElementById("checkinDetailContent"),
  checkinSaveEditsBtn: document.getElementById("checkinSaveEditsBtn"),
  adminChairMessage: document.getElementById("adminChairMessage"),
  chairDashboardRefreshBtn: document.getElementById("chairDashboardRefreshBtn"),
  chairRegisteredEnsemblesList: document.getElementById("chairRegisteredEnsemblesList"),
  chairLunchExportBtn: document.getElementById("chairLunchExportBtn"),
  adminChairDashboardContainer: document.getElementById("adminChairDashboardContainer"),
  stageViewMessage: document.getElementById("stageViewMessage"),
  stageViewPrevBtn: document.getElementById("stageViewPrevBtn"),
  stageViewPositionLabel: document.getElementById("stageViewPositionLabel"),
  stageViewNextBtn: document.getElementById("stageViewNextBtn"),
  stageViewContent: document.getElementById("stageViewContent"),
...
export const state = {
  ...
  admin: {
    ...
    eventEditId: null,
    eventEditName: "",
    eventChairDetailId: null,
    checkinDetailEnsembleId: null,
    logisticsEnsembles: [],
    logisticsCurrentEnsembles: [],
    logisticsNextEnsembles: [],
    logisticsLoadVersion: 0,
    logisticsEnsemblesCache: new Map(),
    logisticsEntriesCache: new Map(),
    logisticsEntriesCacheEventId: "",
    stageViewIndex: 0,
  },
  subscriptions: {
    events: null,

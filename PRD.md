...
* **Event Overview Table (initial release desired UX):** on the event dashboard, show the schedule rows with live status indicators:
...
Initial release – Event-ready MVP:

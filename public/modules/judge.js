...
export async function draftCaptionsFromTranscript({ transcript, formType, context = null }) {
  ...
  try {
    ...
    const payload = { transcript, formType };
    if (context && typeof context === "object") {
      payload.context = context;
    }
    const response = await parseFn(payload);
    return {
      ok: true,
